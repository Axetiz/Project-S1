...
OrbitSimLite is a small educational C++17 library and demo (Made by Axetiz and ArameGevorgyan) for simulating and visualizing simple 2D Newtonian orbits. It uses SI units (meters, kilograms, seconds) and SFML for rendering.
